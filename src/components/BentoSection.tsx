      ...
      <div className=" p-4  max-w-screen-lg mx-auto min-h-screen">
        ...
        */}
        <div className="pt-20 grid gap-4 grid-cols-1 md:grid-cols-3 md:grid-rows-6 min-h-[54rem]">
          ...
          {/* Box 1 */}
          <div className="bg-black/30 hover:bg-cyan-300 flex items-center justify-center p-4 rounded">
          ...
          <div className="bg-black/30 hover:bg-cyan-300 flex items-center justify-center p-4 rounded md:col-span-1 md:row-span-2">
            <p className="text-center font-bold">Box 4</p>
          </div>
  
          {/* Box 5 (spans 2 cols & 2 rows at md+) */}
          <div className="bg-black/30 hover:bg-cyan-300 flex items-center justify-center p-4 rounded md:col-span-2 md:row-span-2">
            <p className="font-bold">Box 5</p>
          </div>
  
          {/* Box 6 (spans 3 cols & 2 rows at md+) */}
          <div className="bg-black/30 hover:bg-cyan-300 flex items-center justify-center p-4 rounded md:col-span-3 md:row-span-2">
            <p className="font-bold">Box 6</p>
          </div>
  
          {/* Box 7 (spans 3 cols & 1 row at md+) */}
          <div className="bg-black/30 hover:bg-cyan-300 flex items-center justify-center p-4 rounded md:col-span-3 md:row-span-1">
